    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="card col-md-2">
                <img src="<?php echo 'image/'.$buku['image']?>" class="card-img-top" alt="Foto Buku" width="20px" height="170px" />
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-success" onclick='Detail(<?php echo json_encode($buku); ?>)'
